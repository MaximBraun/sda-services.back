...
class QwenController:
    ...
    async def photo_to_toybox(
        ...
        return await self._client.photo_to_toybox(
            body,
            image,
            app_id,
            user_id,
    ...
    async def reshape_to_photo(
        ...
        return await self._client.reshape_to_photo(
            body,
            image,
            app_id,
            user_id,
    ...
    async def text_to_post(
        ...
        return await self._client.text_to_post(
            body,
            app_id,
            user_id,
        )
    ...
    async def photo_to_gamestone(
        ...
        return await self._client.photo_to_gamestone(
            image,
            app_id,
            user_id,
        )
    ...
    async def fetch_day_fact(
        ...
        return await self._client.fetch_day_fact(
            app_id,
            user_id,
        )
    ...
    async def photo_to_honesty(
        ...
        return await self._client.photo_to_honesty(
            image,
            app_id,
            user_id,
        )
